package classes.financeiro.formas_de_pagamento.beans;
...
public String getPadraoTab() { return "<html><font color="+(this.padrao!=null && this.padrao.compareTo("S")==0?"green>SIM":"blue>NAO")+"</font></html>";}
