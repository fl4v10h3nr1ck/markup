...
protected Grupo_fornecedor retorno;
	...
	public FormGrupoBase(String titulo, int largura, int altura, Grupo_fornecedor retorno) {
	...
	protected boolean validation(){
		...
		Mensagens.msgDeErro("Informe um código para o grupo.");
		...
		Mensagens.msgDeErro("O código informado já está sendo usado por outro grupo.");
		Comuns.textFieldErroMode(this.tf_codigo);
		return false;	
		}
