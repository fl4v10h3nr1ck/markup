...
public Categoria retorno;
	...
	public FormCategoriaBase(String titulo, int largura, int altura, Categoria retorno) {
	...
	p1.setBackground(Configuracoes.preferencias.cor_fundo_janela);
	this.add(p1, cons);
	...
	cons.weightx = 0.2;
	cons.insets = new Insets( 2, 2, 2, 2);
	this.tf_codigo = new CampoLimitado(12);
