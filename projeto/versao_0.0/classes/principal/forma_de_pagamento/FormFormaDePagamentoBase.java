...
protected FormaDePagamento retorno;
	...
	public FormFormaDePagamentoBase(String title, FormaDePagamento retorno) {
	...
	List<FormaDePagamento> formas_padrao  =  new DAO<FormaDePagamento>(FormaDePagamento.class).get(null, "f_pag.padrao='SIM' and f_pag.status='ATIVO'", null);
