...
@Anot_BD_Tabela(nome="fornecedores", prefixo="forn")
...
@Anot_TB_Coluna(posicao=0, rotulo="Nome/Razão Social", comprimento = 35)
...
@Anot_TB_Coluna(posicao=3, rotulo="Responsável", comprimento = 20)
